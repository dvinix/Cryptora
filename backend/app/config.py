...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = "*"  # Comma-separated origins, e.g. "http://localhost:5173,https://cryptora.vercel.app"
    CORS_ALLOW_CREDENTIALS: bool = False  # Set to True only if using credentials with restricted origins
    
    # Security - JWT configuration
    JWT_SECRET_KEY: str = "cryptora-default-secret-key-change-in-production"
